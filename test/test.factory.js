...
tape( 'the function returns a factory function (parameters)', function test( t ) {
	var createStream = factory( 2, 5.0 );
	t.strictEqual( typeof createStream, 'function', 'returns expected value' );
	t.end();
});
...
tape( 'the function returns a function which throws an error if shape parameter `k` is not a positive integer', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns a function which throws an error if shape parameter `k` is not a positive integer (parameters)', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns a function which throws an error if rate parameter `lambda` is not a positive number primitive', function test( t ) {
	var values;
	var i;
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory();
			createStream( 2, value );
		};
	}
});

tape( 'the function returns a function which throws an error if rate parameter `lambda` is not a positive number primitive (parameters)', function test( t ) {
	var values;
	var i;
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory( 2, value );
			createStream();
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an options argument which is not an object (parameters)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			var createStream = factory( 2, 5.0, value );
			createStream();
		};
	}
});
...
tape( 'the function returns a factory function which creates stream instances', function test( t ) {
	...
	for ( i = 0; i < 10; i++ ) {
		t.strictEqual( createStream( 2, 5.0 ) instanceof RandomStream, true, 'returns expected value' );
	}
	t.end();
});
