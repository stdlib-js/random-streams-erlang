...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from an Erlang distribution.
*/
declare class RandomStream extends Readable {
	...
	*/
	...
	/**
	* Pseudorandom number generator for generating Erlang distributed pseudorandom numbers.
	*/
	...
	*
	* @example
	* var stream = new RandomStream( 2, 5.0 );
...
interface Constructor {
	...
	* };
	*
	* var createStream = RandomStream.factory( 2, 5.0, opts );
	*
	...
	* }
	*/
	factory( k: number, lambda: number, options?: Options ): ( ...args: Array<any> ) => RandomStream; // tslint:disable-line: max-line-length
	...
	* }
	*/
	factory( options?: Options ): ( k: number, lambda: number ) => RandomStream; // tslint:disable-line: max-line-length

	/**
	* Returns an "objectMode" readable stream for generating a stream of pseudorandom numbers drawn from an Erlang distribution.
	*
	* @param k - shape parameter
	* @param lambda - rate parameter
	* @param options - stream options
	...
	* };
	*
	* var stream = RandomStream.objectMode( 2, 5.0, opts );
	*
