...
```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-erlang@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-streams-erlang/tags). For example,

```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-erlang@v0.2.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var randomStream = require( 'path/to/vendor/umd/random-streams-erlang/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-erlang@umd/browser.js"></script>
```
...
Returns a [readable stream][readable-stream] for generating pseudorandom numbers drawn from an [Erlang][erlang] distribution with parameters `k` (shape) and `lambda` (rate).
...
var stream = randomStream( 2, 5.0, opts );
```
...
var stream = randomStream( 2, 1.0, opts );
...
var stream = randomStream( 2, 5.0, opts1 );
...
stream = randomStream( 2, 5.0, opts3 );
...
#### randomStream.factory( \[k, lambda, ]\[options] )

Returns a `function` for creating [readable streams][readable-stream] which generate pseudorandom numbers drawn from an [Erlang][erlang] distribution.
...
```javascript
var createStream = randomStream.factory( 2, 2.0 );
...
var stream1 = createStream( 2, 2.0 );
var stream2 = createStream( 2, 2.0 );
// ...
```
...
#### randomStream.objectMode( k, lambda\[, options] )
...
var stream = randomStream.objectMode( 2, 2.0, opts );
...
var stream = randomStream( 2, 2.0, opts );
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-streams-erlang.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-streams-erlang

[test-image]: https://github.com/stdlib-js/random-streams-erlang/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/random-streams-erlang/actions/workflows/test.yml?query=branch:v0.2.1
...
[deno-readme]: https://github.com/stdlib-js/random-streams-erlang/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-streams-erlang/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-streams-erlang/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-streams-erlang/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-streams-erlang/blob/esm/README.md
